...
<body class="bg-secondary">
    ...
    <!-- Body -->
    <div class="w-100 align-items-center justify-content-center text-center p-5 d-flex" style="height:100%;">
        <div class="w-50-lg w-100-md text-center m-auto p-5">
            <h2 class="text-light">Desarrolado por: Luis Angel Aguilar Torres</h2>
            <h3 class="text-light">Miercoles 06 de enero de 2021</h3>
            <div class="w-100 mt-5">
                <h3 class="text-light">Crud para usuarios y Mascotas</h3>
                <div class="w-50 m-auto d-flex justify-content-around">

                <a href="" class="btn btn-outline-dark">Dueños</a>
                <a href="" class="btn btn-outline-dark">Mascotas</a>
                </div>
            </div>
        </div>
